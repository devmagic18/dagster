...
from dagster_dbt.asset_defs import load_assets_from_dbt


def test_load_from_manifest_path():
    assets = load_assets_from_dbt(
...
def test_load_from_manifest_json():
    ...
    assets = load_assets_from_dbt(manifest_json=manifest_json)
    assert_assets_match_project(assets)
